...
const RegisterForm = () => {
    ...
    const hundleLogin = (e) => {
        ...
        axios.post("http://34.175.22.39:5000/api/users/login",loginInfo, {withCredentials:true})
            .then(res => {
        ...
        <StyledWrapper>
            <div className="form-container">
                ...
                <div className="social-message">
                    ...
                    <p className="signup  mb-5">Don't have an account?</p>
                    <div className="line  mb-5" />
                </div>
                <Link rel="noopener noreferrer" to={"/signup"} className='mx-20 mt-5 px-4 py-2 bg-[#a78bfa] rounded-md' >Sign up</Link>
            </div>
        </StyledWrapper>
    );
}
